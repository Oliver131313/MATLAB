...
disp(data_raw.('Student'))
% ...a len niektoreho prvku
disp(data_raw.('U_O')(2:5))
...
for ii=kategorie
    % varianta 1
%     ind2=strfind(data_raw.Obor, ii);
%     ind2= cellfun(@isempty,ind2);
%     ind2=~ind2;
    % varianta 2
    ind2=contains(data_raw.Obor, ii);
    
    data_raw.Obor_kategorie(ind2)=ii;
end
...
% disp([data_str(1).Student, num2str(data_str(1).Celkom_test)])
% Vhodnejsia varianta
